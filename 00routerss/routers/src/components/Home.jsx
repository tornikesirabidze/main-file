...
function Home() {
    return (
        <div className=' w-full h-[100vh] flex text-center p-[1.5rem]'>
            <div className='flex lg:flex-row flex-col pb-[1rem] lg:gap-0 gap-[2rem] lg:justify-between justify-end lg:items-end items-center w-full ' >
                <div className='pb-0 text-white  '>
                    ...
                    <p className='--fontfamily--200 --paragraph--100 primary heading-font-100-color--200 sm:max-w-[28rem] max-w-[30rem]' >{heroText[0].p}</p>
                </div>
